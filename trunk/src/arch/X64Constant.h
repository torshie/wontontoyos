...
DEFINE(APIC_REGISTER_ENTRY_TIMER, 0x320)
DEFINE(APIC_REGISTER_ENTRY_THERMAL, 0x330)
DEFINE(APIC_REGISTER_ENTRY_PERFORMANCE_COUNTER, 0x340)
DEFINE(APIC_REGISTER_ENTRY_LINT0, 0x350)
DEFINE(APIC_REGISTER_ENTRY_LINT1, 0x360)
DEFINE(APIC_REGISTER_ENTRY_ERROR, 0x370)
