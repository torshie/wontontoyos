 ...
 *
 * XXX This is just a temporary work around, implement a full blow one.
 */
...
public:
	enum {
		...
		/**
		 * If you want to change this const, make sure you have changed
...
private:
	 ...
	 */
	static void handle(NativeUnsigned isrNumber);
