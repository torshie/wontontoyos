...
typename MaxHeap<Key, Data, Allocator>::Node*
MaxHeap<Key, Data, Allocator>::insert(const Key& key, const Data& data) {
...
template<typename Key, typename Data, typename Allocator>
void MaxHeap<Key, Data, Allocator>::remove(Node* node) {
	--nodeCount;
...
template<typename Key, typename Data, typename Allocator>
void MaxHeap<Key, Data, Allocator>::swap(Node* first, Node* second) {
	if (first == second) {
		return;
	}
...
template<typename Key, typename Data, typename Allocator>
typename MaxHeap<Key, Data, Allocator>::Node*
MaxHeap<Key, Data, Allocator>::sink(Node* node) {
	Node* largest = node;
...
template<typename Key, typename Data, typename Allocator>
typename MaxHeap<Key, Data, Allocator>::Node*
MaxHeap<Key, Data, Allocator>::bubble(Node* node) {
...
template<typename Key, typename Data, typename Allocator>
typename MaxHeap<Key, Data, Allocator>::Node*
MaxHeap<Key, Data, Allocator>::getParentNode(Size index) {
	Size parent = index / 2;
...
#ifdef ENABLE_RUNTIME_CHECK
template<typename Key, typename Data, typename Allocator>
int MaxHeap<Key, Data, Allocator>::getHeapHeight(const Node* node) {
	if (node == 0) {
		return 0;
	}
...
#endif // #ifdef ENABLE_RUNTIME_CHECK
